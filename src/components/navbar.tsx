        ...
        <div className="flex justify-between items-center">
          ...
          <Link href="/" className="flex items-center gap-3">
            ...
            <span className={`text-2xl font-black tracking-tighter ${
              ...
              SRES <span className="text-brand-primary font-bold">Electric</span>
            </span>
          </Link>
          ...
          <div className="hidden lg:flex items-center gap-8 xl:gap-12">
              ...
              {navLinks.map((link) => {
                ...
                return (
                  ...
                  >
                    {link.name}
                    <span 
                      className={`absolute -bottom-1 left-0 w-full h-0.5 bg-brand-primary transition-transform origin-left ${
            ...
            <Link
              ...
              className={`px-6 py-2.5 rounded-full font-bold text-sm transition-all flex items-center gap-2 ${
                isScrolled || pathname !== "/"
                  ? "bg-brand-primary hover:bg-brand-dark text-white shadow-lg shadow-brand-primary/20 hover:shadow-brand-primary/40 hover:-translate-y-0.5"
          ...
          {navLinks.map((link) => (
            <Link
              ...
              className={`text-lg font-bold ${
                pathname === link.href ? "text-brand-primary" : "text-gray-800"
              }`}
            >
              {link.name}
            </Link>
