      ...
      <div className="container mx-auto px-4 md:px-8 xl:px-12 max-w-[1400px]">
        ...
        <div className="max-w-4xl mx-auto text-center mb-24">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-gray-900 leading-tight tracking-tighter mb-8">
            Decades of <span className="text-brand-primary relative inline-block">
              Excellence.
              <svg className="absolute w-full h-3 -bottom-1 left-0 text-brand-primary/20 -z-10" viewBox="0 0 100 10" preserveAspectRatio="none">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center mb-32">
          <div className="order-2 lg:order-1 relative">
            <div className="aspect-[4/5] md:aspect-[3/4] rounded-[2rem] overflow-hidden bg-gray-100 border border-gray-200 relative shadow-2xl flex flex-col items-center justify-center text-gray-400 group">
              <Image src="/corporate_office.png" alt="SRES Corporate Office and Factory" fill className="object-cover z-0 transition-transform duration-700 group-hover:scale-105 mix-blend-multiply" priority />
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="prose prose-lg text-gray-600 mb-10">
              <p className="mb-6 leading-relaxed">
                Since 1994, our core competencies have included detailed engineering, erection, testing, and commissioning (ETC) of HT and EHV switchyards and substations up to <strong className="text-brand-dark font-bold bg-brand-bg/10 px-1 rounded">765kV</strong>.
              </p>
              <p className="mb-6 leading-relaxed">
