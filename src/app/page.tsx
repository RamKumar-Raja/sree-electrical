        ...
        <div className="container relative z-20 mx-auto px-4 md:px-8 xl:px-12 max-w-[1400px]">
          <div className="max-w-[800px] mx-auto text-center flex flex-col items-center">
            ...
            >
              ...
              <motion.span variants={titleWord} className="inline-block text-transparent bg-clip-text bg-gradient-to-r from-brand-primary to-brand-secondary drop-shadow-sm filter">
                Absolute Precision.
              </motion.span>
            </motion.h1>
            ...
            >
              <MagneticButton>
                <Link href="/services" className="group w-full relative overflow-hidden bg-brand-primary border border-brand-primary hover:bg-brand-bg text-black hover:text-white px-8 py-4 rounded-xl font-bold text-lg transition-all text-center flex items-center justify-center shadow-[0_0_40px_rgba(155,244,103,0.3)] min-w-[200px]">
                  <span className="relative z-10 transition-transform group-hover:-translate-x-2">Our Solutions</span>
                  <div className="absolute right-4 top-1/2 -translate-y-1/2 w-8 h-8 bg-black/10 rounded-lg flex items-center justify-center transition-all group-hover:bg-brand-primary z-10">
                    <ArrowRight size={18} className="text-black group-hover:text-black opacity-0 group-hover:opacity-100 transition-opacity" />
                  </div>
              ...
              <MagneticButton>
                <a href="/assets/sres-company-profile.pdf" target="_blank" className="w-full bg-[#0f1a2e]/50 backdrop-blur-md border border-slate-700/50 hover:bg-[#1a2b4a]/60 hover:border-brand-primary/30 text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all text-center flex items-center justify-center gap-3 min-w-[200px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 xl:gap-8">
            {[
              ...
              <ScrollReveal key={i} delay={i * 0.15}>
                <TiltCard>
                  <Link href={feature.route} className="group flex flex-col h-full p-8 xl:p-10 rounded-3xl bg-gray-50/50 outline outline-1 outline-gray-100 hover:bg-white hover:shadow-2xl hover:shadow-brand-primary/10 transition-all duration-300 relative z-30">
                    ...
                    <p className="text-gray-500 font-medium group-hover:text-brand-dark/80 transition-colors flex items-center gap-2 mt-auto">
                      {feature.desc} 
