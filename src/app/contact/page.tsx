    ...
    <main className="pt-32 pb-24 min-h-screen relative">
      ...
      <div className="container relative z-10 mx-auto px-4 md:px-8 xl:px-12 max-w-[1400px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 relative">
          ...
          {/* Form */}
          <div className="lg:col-span-3 bg-white/5 backdrop-blur-sm p-8 md:p-12 rounded-[2rem] border border-white/10 relative z-20">
            ...
            <form className="space-y-8" name="contact" method="POST" data-netlify="true" action="/success">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-2">
                  ...
                  <input type="text" required placeholder="John Doe" className="w-full px-5 py-4 rounded-xl border border-white/20 focus:outline-none focus:ring-4 focus:ring-brand-primary/10 focus:border-brand-primary transition-all bg-white/5 hover:bg-white/10 text-white placeholder:text-gray-500 font-medium" />
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-bold text-gray-300 uppercase tracking-wider">Email Address *</label>
                  <input type="email" required placeholder="john@company.com" className="w-full px-5 py-4 rounded-xl border border-white/20 focus:outline-none focus:ring-4 focus:ring-brand-primary/10 focus:border-brand-primary transition-all bg-white/5 hover:bg-white/10 text-white placeholder:text-gray-500 font-medium" />
                </div>
              </div>

              <div className="space-y-2">
                <label className="text-sm font-bold text-gray-300 uppercase tracking-wider">Phone Number</label>
                <input type="tel" placeholder="+91 98765 43210" className="w-full px-5 py-4 rounded-xl border border-white/20 focus:outline-none focus:ring-4 focus:ring-brand-primary/10 focus:border-brand-primary transition-all bg-white/5 hover:bg-white/10 text-white placeholder:text-gray-500 font-medium" />
              </div>

              <div className="space-y-2">
                <label className="text-sm font-bold text-gray-300 uppercase tracking-wider">Your Message *</label>
                <textarea required rows={5} placeholder="Describe your project, requirements, or enquiry..." className="w-full px-5 py-4 rounded-xl border border-white/20 focus:outline-none focus:ring-4 focus:ring-brand-primary/10 focus:border-brand-primary transition-all bg-white/5 hover:bg-white/10 text-white placeholder:text-gray-500 font-medium resize-none"></textarea>
              </div>

              {/* Notice for Internship */}
              <div className="bg-brand-primary/5 p-4 rounded-xl border border-brand-primary/20 flex gap-4 items-start">
                  <AlertCircle size={24} className="text-brand-primary shrink-0 mt-0.5" />
                  <div>
                    <h5 className="font-bold text-sm text-white mb-1">Applying for an internship?</h5>
                    <p className="text-xs text-slate-400 font-medium leading-relaxed mb-0">Please mention "Internship" in your message, or call the Admin Office directly. We offer hands-on training opportunities.</p>
                  </div>
              </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="bg-white/5 backdrop-blur-sm p-8 md:p-10 rounded-[2rem] border border-white/10 relative overflow-hidden">
                ...
                <div className="space-y-6">
                    <div className="flex gap-5 group items-center">
                        <div className="w-12 h-12 rounded-xl bg-white/10 text-slate-300 flex items-center justify-center shrink-0 border border-white/20 group-hover:bg-brand-primary group-hover:text-black group-hover:border-brand-primary transition-colors duration-300">
                            <Phone size={20} />
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
                        <div className="flex gap-4 items-start group">
                            <div className="w-10 h-10 rounded-lg bg-white/10 text-slate-400 flex items-center justify-center shrink-0 border border-white/20 group-hover:border-brand-primary group-hover:text-brand-primary transition-colors duration-300">
                                <Phone size={16} />
                            </div>
                            <div>
                        ...
                        <div className="md:col-span-2 mt-2 border border-white/10 p-5 rounded-xl flex flex-col gap-4 focus-within:border-brand-primary transition-colors hover:border-brand-primary/50 bg-white/5">
            ...
            <div className="w-full h-64 md:h-80 bg-[#0d1c35] rounded-[2rem] overflow-hidden relative border border-white/10">
              <iframe
